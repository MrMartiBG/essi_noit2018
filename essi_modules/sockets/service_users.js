module.exports = function(socket,database){
	...
	// 	database.set_service_user(service_user, function(err, results){
	// 		if(err) return socket.fail(func_name, {errmsg: "database error set_service_user", code: err.code}, call_back);
	// 		return socket.successful(func_name, results, call_back);
	// 	});
	...
	// 	database.delete_service_user(service_user, function(err, results){
